import type { EAIConstraintType, EAIMovementPose, EALifeDirectorScenarioTarget, EALifeFactionGoalType, EALifeGroupPriorityType, EAbility, EAbilityStatePhase, EActionType, EAgentArchetype, EAgentRankMask, EAgentType, EAimAssistPresetType, EAimAssistWeightType, EAmmoCaliber, EAmmoType, EAnimationReloadTypes, EAnomalyElementType, EAnomalyType, EApplyRestrictionType, EArchiartifactType, EArmorScale, EArtifactRarity, EArtifactSpawnerExcludeRule, EArtifactType, EAttachSlot, EAttachType, EAttractionPointType, EAudioRoomPresetBandwidth, EAvailableCoverActionsSide, EAvailableCoverEnterTypes, EBehaviorType, EBeneficial, EBodyMeshType, EBoltActionWeaponState, EBoolProviderType, EBrokenGameDataFilter, ECalculateSignificance, ECameraShakeEffectSubtype, ECameraShakeGroupType, ECameraShakeType, ECauseOfDeath, EChangeValueMode, ECollisionChannel, ECollisionFormType, ECombatTactics, EConditionComparance, EConnectionLineState, EConsumableType, EContextualActionBodyPart, EContextualActionNeeds, EContextualActionNodeType, EContextualAgentType, ECrosshairType, ECustomDataDistribution, EDamageBone, EDamageSource, EDamageType, EDeadZoneType, EDestructionActionType, EDetectorType, EDialogAction, EDialogEventType, EDialogPriority, EDuplicateResolveType, EEffectDisplayType, EEffectSource, EEffectType, EEmissionAIEvent, EEmissionStage, EEmotionalFaceMasks, EEvadeActionType, EFaceBlockingBlendMasks, EFastUseGroupType, EFireType, EFlashlightAction, EFlashlightPriority, EFleeType, EFloatProviderType, EGSCTeleportType, EGameDifficulty, EGlobalVariableType, EGoalPriority, EGrenadeType, EGuardType, EHealingType, EHideViewType, EIgnoreDamageType, EInputAxisType, EInputController, EInputKey, EInputMappingContextPriority, EInteractFXType, EInventoryEquipmentSlot, EItemContainerType, EItemInfoType, EItemType, EJamType, EJournalAction, EJournalEntity, ELairPreferredSpawnType, ELairType, ELineDirection, ELoadingDestination, ELocalizationLanguage, EMagazineMeshType, EMainHandEquipmentType, EMappingContext, EMarkerType, EMeshSubType, EMisansceneNodeType, EModifiedCharacterParam, EModifyAbilitySequenceQuestNodeMode, EMovementBehaviour, EMusicState, EMutantAttackType, ENPCType, ENiagaraProviderType, ENoteType, ENotificationEventType, EObjAnim, EObjBoolParams, EObjFloatParams, EObjMesh, EObjSkeletalMeshTraceBone, EObjType, EOverrideDialogTopic, EOverweightLock, EPDATutorialCategory, EPassiveDetectorType, EPhysicalMaterialType, EPillowAnomalyBiomeType, EPlayerActionInputModifier, EPlayerActionInputTrigger, EPostEffectProcessorType, EPostProcessEffectType, EPsyNPCType, EQuestEventType, EQuestNodeType, ERadiationInnerOffsetPreset, ERadiationPreset, ERank, ERegion, ERelationChangingEvent, ERelationLevel, ERequiredSquadMembers, ESaveSubType, ESaveType, ESmartCoverType, ESortGroup, ESoundEffectSubtype, ESoundEventType, ESpaceRestrictionType, ESpawnNodeExcludeType, ESpawnType, ESpeechEventType, EStaminaAction, EStateTag, ESummonBehaviourOnSpawn, ESummonSpawnOrientation, EThreatActionType, EThreatType, EThrowQueueDisarmMode, ETriggerReact, ETriggerShape, EUISound, EUpgradeTargetPartType, EUpgradeVerticalPosition, EUserNotificationType, EVitalType, EWaterImmersionLevel, EWeaponState, EWeaponType, EWeather, EWeatherParam, EWeightStatus, EZombificationType, EDialogAnimationType, EItemGenerationCategory, EContextualActionEffectType, ERepetitions, EDistanceSelectorCondition, EContextualActionPreconditionType, EQuestConditionType, EJournalState, EQuestNodeState, EScenarioBranch, EThreatAwareness, EConditionCheckType, EQuestRewardType } from "./enums.mjs";
import type { GetStructType, Struct } from "./Struct.mjs";
import type { Archetype, Caliber, EffectConditionalEffect, Faction, FactionGoalType, HumanAbilityName, MeshSlotName, ObjectAbilityName, Rank, Reaction, ScenarioGroup, SID, StringArray, VariableValue, WeaponShootDistance, WeatherSelection } from "./utility-types.mjs";
...
export type AbilityPrototypeAkEvents = GetStructType<AbilityPrototypeAkEventsItem[]>;
export type AbilityPrototypeAkEventsItem = GetStructType<{
    AkEvent: string;
    AkSwitches: SingletonConstantArmy;
}>;
export type AbilityPrototypeAnomalies = GetStructType<AbilityPrototypeAnomaliesItem[]>;
export type AbilityPrototypeAnomaliesItem = GetStructType<{
    NiagaraPath: string;
    SID: string;
}>;
export type AbilityPrototypeBonesDamageSet = GetStructType<AbilityPrototypeBonesDamageSetItem>;
export type AbilityPrototypeBonesDamageSetItem = GetStructType<{
    DamageBone: EDamageBone;
}>;
export type AbilityPrototypeConditionalCooldowns = GetStructType<AbilityPrototypeConditionalCooldownsItem[]>;
...
export type AbilityPrototypeEffects = GetStructType<AbilityPrototypeEffectsItem[]>;
export type AbilityPrototypeEffectsDistanced = GetStructType<AbilityPrototypeEffectsDistancedItem[]>;
...
export type AbilityPrototypeIgnoredCalibersSet = GetStructType<AbilityPrototypeIgnoredCalibersSetItem[]>;
...
export type AbilityPrototypeSummonObjects = GetStructType<AbilityPrototypeSummonObjectsItem[]>;
...
export type AbilityPrototypeTriggeredCooldowns = GetStructType<AbilityPrototypeTriggeredCooldownsItem[]>;
...
export type AIGlobalAudioRoomLoudnessMultiplierList = GetStructType<AIGlobalAudioRoomLoudnessMultiplierListItem[]>;
...
export type AIGlobalCharacterPoseSettings = GetStructType<AIGlobalCharacterPoseSettingsItem[]>;
...
export type AIGlobalFlashlightUseTracePoints = GetStructType<AIGlobalFlashlightUseTracePointsItem[]>;
...
export type AIGlobalMaterialTranslucencyList = GetStructType<AIGlobalMaterialTranslucencyListItem[]>;
...
export type AIGlobalMutantCorpseProcessFactionPerRank = GetStructType<AIGlobalMutantCorpseProcessFactionPerRankItem[]>;
export type AIGlobalMutantCorpseProcessFactionPerRankItem = GetStructType<{
    AllowedRanks: AIGlobalAllowedRanks;
    Faction: string;
}>;
export type AIGlobalPhysMatSettings = GetStructType<AIGlobalPhysMatSettingsItem[]>;
...
export type AIGlobalRoomBaseCoefficients = GetStructType<AIGlobalRoomBaseCoefficientsItem[]>;
...
export type AIGlobalTimeOfDayBaseLuminance = GetStructType<AIGlobalTimeOfDayBaseLuminanceItem[]>;
...
export type AIGlobalWeaponAttachmentsModifiersList = GetStructType<AIGlobalWeaponAttachmentsModifiersListItem[]>;
...
export type AIGlobalWeatherLuminanceCoefficients = GetStructType<AIGlobalWeatherLuminanceCoefficientsItem[]>;
export type AIGlobalWeatherLuminanceCoefficientsItem = GetStructType<{
    Coefficient: number;
    WeatherType: EWeather;
}>;
export type AIGlobalWeatherSettings = GetStructType<AIGlobalWeatherSettingsItem[]>;
...
export type AimAssistWeightsPrototypeWeightRules = GetStructType<AimAssistWeightsPrototypeWeightRulesItem[]>;
...
export type ALifeDirectorScenarioPrototypeALifeScenarioNPCArchetypesLimitsPerPlayerRank = GetStructType<ALifeDirectorScenarioPrototypeALifeScenarioNPCArchetypesLimitsPerPlayerRankItem[]>;
export type ALifeDirectorScenarioPrototypeALifeScenarioNPCArchetypesLimitsPerPlayerRankItem = GetStructType<{
    Rank: ERank;
...
export type ALifeDirectorScenarioPrototypeMutant_AttackEnemyLair = GetStructType<{
...
export type ALifeDirectorScenarioPrototypeProhibitedAgentTypes = GetStructType<EAgentType[]>;
export type ALifeDirectorScenarioPrototypeRestrictedObjPrototypeSIDs = StringArray;
export type ALifeDirectorScenarioPrototypeRestrictions = GetStructType<ALifeDirectorScenarioPrototypeRestrictionsItem[]>;
...
export type ALifeDirectorScenarioPrototypeScenarioSquads = GetStructType<ALifeDirectorScenarioPrototypeScenarioSquadsItem[]>;
...
export type ALifePopulationManagerFactionPrototypeALifeFactionGoals = GetStructType<{
...
export type AnomalyPrototypeBonesToTrace = GetStructType<EObjSkeletalMeshTraceBone[]>;
...
export type ArmorPrototypeMeshGenerator = GetStructType<ArmorPrototypeMeshGeneratorItem[]>;
export type ArmorPrototypeMeshGeneratorItem = GetStructType<{
    MeshGeneratorPrototypeSID: string;
    Weight: number;
}>;
export type ArmorPrototypeNpcMeshGenerator = GetStructType<ArmorPrototypeMeshGeneratorItem[]>;
...
export type ArmorPrototypeSectionSettings = GetStructType<ArmorPrototypeSectionSettingsItem[]>;
...
export type ArtifactPrototypeAnomalyDamageDeflections = GetStructType<ArtifactPrototypeAnomalyDamageDeflectionsItem[]>;
...
export type ArtifactPrototypeEffectsDisplayTypes = GetStructType<EEffectDisplayType[]>;
...
export type ArtifactSpawnerPrototypeExcludeRules = GetStructType<EArtifactSpawnerExcludeRule[]>;
...
export type AttachMeshPrototypeAdditionalMesh = GetStructType<AttachMeshPrototypeAdditionalMeshItem[]>;
...
export type AttachMeshPrototypeBoxCollisions = GetStructType<AttachMeshPrototypeBoxCollisionsItem[]>;
...
export type AttachMeshPrototypeCapsuleCollisions = GetStructType<AttachMeshPrototypeCapsuleCollisionsItem[]>;
...
export type AttachMeshPrototypeMaterialInstanceParameters = GetStructType<AttachMeshPrototypeMaterialInstanceParametersItem[]>;
export type AttachMeshPrototypeMaterialInstanceParametersItem = GetStructType<{
    ParameterName: string;
    TexturePath: string;
}>;
export type AttachMeshPrototypeMaterialLODs = GetStructType<AttachMeshPrototypeMaterialLODsItem[]>;
export type AttachMeshPrototypeMaterialLODsItem = GetStructType<{
    LODLevel: number;
    LODSectionIndex: number;
    MaterialPostfix: string;
}>;
export type AttachMeshPrototypeMaterials = GetStructType<AttachMeshPrototypeMaterialsItem[]>;
...
export type AttachMeshPrototypeVariations = GetStructType<AttachMeshPrototypeVariationsItem[]>;
...
export type AttachPrototypeFPParticlesBasedOnHeating = GetStructType<AttachPrototypeFPParticlesBasedOnHeatingItem[]>;
...
export type AttachPrototypeMeshArray = GetStructType<AttachPrototypeMeshArrayItem[]>;
...
export type AudioScattererPrototypeListOf3DEvents = GetStructType<AudioScattererPrototypeListOf3DEventsItem[]>;
...
export type AudioScattererPrototypeListOfBrushes = GetStructType<AudioScattererPrototypeListOfBrushesItem[]>;
...
export type BenchmarkItemGeneratorPrototypeItemGenerator = GetStructType<BenchmarkItemGeneratorPrototypeItemGeneratorItem[]>;
...
export type BenchmarkItemGeneratorPrototypePossibleItems = GetStructType<BenchmarkItemGeneratorPrototypePossibleItemsItem[]>;
...
export type BenchmarkMeshGeneratorPrototypeAttaches = GetStructType<BenchmarkMeshGeneratorPrototypeAttachesItem[]>;
...
export type BenchmarkMeshGeneratorPrototypeAttachments = GetStructType<BenchmarkMeshGeneratorPrototypeAttachmentsItem[]>;
export type BenchmarkMeshGeneratorPrototypeAttachmentsItem = GetStructType<{
    Attaches: BenchmarkMeshGeneratorPrototypeAttaches;
    SlotName: string;
}>;
export type BenchmarkMeshGeneratorPrototypeCustomData = GetStructType<BenchmarkMeshGeneratorPrototypeMaterialsItem[]>;
export type BenchmarkMeshGeneratorPrototypeGroom = GetStructType<BenchmarkMeshGeneratorPrototypeGroomItem[]>;
export type BenchmarkMeshGeneratorPrototypeGroomItem = GetStructType<{
    CategoryName: string;
    Variations: BenchmarkMeshGeneratorPrototypeVariations;
}>;
export type BenchmarkMeshGeneratorPrototypeMaterials = GetStructType<BenchmarkMeshGeneratorPrototypeMaterialsItem[]>;
export type BenchmarkMeshGeneratorPrototypeMaterialsItem = GetStructType<{
    MaterialGroup: string;
    Variations: BenchmarkMeshGeneratorPrototypeVariations;
}>;
export type BenchmarkMeshGeneratorPrototypeVariations = GetStructType<BenchmarkMeshGeneratorPrototypeVariationsItem[]>;
...
export type BodyMeshPrototypeAdditionalMesh = GetStructType<BodyMeshPrototypeAdditionalMeshItem[]>;
export type BodyMeshPrototypeAdditionalMeshItem = GetStructType<{
    MeshPath: string;
}>;
export type BodyMeshPrototypeMaterials = GetStructType<BodyMeshPrototypeMaterialsItem[]>;
export type BodyMeshPrototypeMaterialsItem = GetStructType<{
    MaterialGroup: string;
    MaterialSlot: number;
    Variations: BodyMeshPrototypeVariations;
}>;
export type BodyMeshPrototypeVariations = GetStructType<BodyMeshPrototypeVariationsItem[]>;
...
export type CameraManagerConstant = GetStructType<CameraManagerConstantFlagToMaterialItem[]>;
...
export type CharacterWeaponSettingsPrototypeCombatSynchronizationScore = GetStructType<NPCWeaponSettingsPrototypeCombatSynchronizationScoreItem[]>;
...
export type CombatSynchronizationPrototypeFilterGroups = GetStructType<CombatSynchronizationPrototypeFilterGroupsItem[]>;
...
export type CombatSynchronizationPrototypeSynchronizationPrimitives = GetStructType<NPCWeaponSettingsPrototypeCombatSynchronizationScoreItem[]>;
...
export type ConstraintPrototypeConstraints = GetStructType<ConstraintPrototypeConstraintsItem[]>;
...
export type ConsumablePrototypeEffectsDisplayTypes = GetStructType<EEffectDisplayType[]>;
export type ConsumablePrototypeNegativeEffectPrototypeSIDs = GetStructType<ConsumablePrototypeNegativeEffectPrototypeSIDsItem[]>;
...
export type ContextualActionBlueprintPrototypeAnimationFinalFrameTransforms = GetStructType<ContextualActionBlueprintPrototypeAnimationFinalFrameTransformsItem[]>;
export type ContextualActionBlueprintPrototypeAnimationFinalFrameTransformsItem = GetStructType<ContextualActionBlueprintPrototypeAnimationFinalFrameTransformsItemItem[]>;
export type ContextualActionBlueprintPrototypeAnimationFinalFrameTransformsItemItem = GetStructType<{
    Rotation: SpawnActorPrototypeRotation;
    Vector: AIGlobalRelativeLocation;
}>;
export type ContextualActionBlueprintPrototypeNeeds = GetStructType<EContextualActionNeeds[]>;
export type ContextualActionBodyPartsPrototype = GetStructType<{
    BodyParts: ContextualActionBodyPartsPrototypeBodyParts;
    SID: string;
}>;
export type ContextualActionBodyPartsPrototypeBodyParts = GetStructType<ContextualActionBodyPartsPrototypeBodyPartsItem[]>;
...
export type ContextualActionNodePrototypeAnimationData = GetStructType<ContextualActionNodePrototypeAnimationDataItem[]>;
export type ContextualActionNodePrototypeAnimationDataItem = GetStructType<{
    MontagePath: string;
    MontageSection: string;
}>;
export type ContextualActionNodePrototypeBodyParts = GetStructType<EContextualActionBodyPart[]>;
export interface ContextualActionNodePrototypeConditionalSelectorNodes extends Struct {
    [key: `${number}`]: ContextualActionNodePrototypeConditionalSelectorNodesItem;
}
export interface ContextualActionNodePrototypeConditionalSelectorNodesItem extends Struct {
...
export type ContextualActionNodePrototypeDistanceSelectorNodes = GetStructType<ContextualActionNodePrototypeDistanceSelectorNodesItem[]>;
export type ContextualActionNodePrototypeDistanceSelectorNodesItem = GetStructType<{
    AnimationData: ContextualActionNodePrototypeAnimationData;
    CanInteractWithPlayer: boolean;
    Effects: string;
    Interrupt: ContextualActionNodePrototypeInterrupt;
...
export type ContextualActionNodePrototypeEffects = GetStructType<ContextualActionNodePrototypeEffectsItem[]>;
...
export type ContextualActionNodePrototypePreconditions = GetStructType<ContextualActionNodePrototypePreconditionsItem[]>;
...
export interface ContextualActionNodePrototypeRandomSelectorNodes extends Struct {
    [key: `${number}`]: ContextualActionNodePrototypeRandomSelectorNodesItem;
}
export interface ContextualActionNodePrototypeRandomSelectorNodesItem extends Struct {
...
export interface ContextualActionNodePrototypeSequentialSelectorNodes extends Struct {
    [key: `${number}`]: ContextualActionNodePrototypeSequentialSelectorNodesItem;
}
export interface ContextualActionNodePrototypeSequentialSelectorNodesItem extends Struct {
    AkAudioEvent: NPCPrototypeSkills;
    AnimationData: ContextualActionNodePrototypeAnimationData;
    CanInteractWithPlayer: boolean;
    ConditionalSelectorNodes: ContextualActionNodePrototypeConditionalSelectorNodes;
...
export type ContextualActionNodePrototypeWeights = GetStructType<ContextualActionNodePrototypeWeightsItem[]>;
...
export type CoreVariableAffectingEffectTypes = GetStructType<CoreVariableAffectingEffectTypesItem[]>;
...
export type CoreVariableArtifactSpawnPityStructs = GetStructType<CoreVariableArtifactSpawnPityStructsItem[]>;
...
export type CoreVariableFleshIshPhysicalMaterials = GetStructType<EPhysicalMaterialType[]>;
export type CoreVariableHead = StringArray;
export type CoreVariableItemInfoAffectingEffects = GetStructType<CoreVariableItemInfoAffectingEffectsItem[]>;
...
export type CoreVariableLimpEffectSIDToThresholdMap = GetStructType<CoreVariableLimpEffectSIDToThresholdMapItem[]>;
export type CoreVariableLimpEffectSIDToThresholdMapItem = GetStructType<{
    EffectSID: string;
    Threshold: number;
}>;
export type CoreVariableMovementVFXArmorScale = GetStructType<CoreVariableMovementVFXArmorScaleItem[]>;
export type CoreVariableMovementVFXArmorScaleItem = GetStructType<{
    ArmorProtectionValue: number;
    ArmorScale: EArmorScale;
}>;
export type CoreVariableMutantLootParams = GetStructType<CoreVariableMutantLootParamsItem[]>;
export type CoreVariableMutantLootParamsItem = GetStructType<{
    AgentType: EAgentType;
    CutDecalBoneName: string;
    CutRadiusModifier: number;
}>;
export type CoreVariableNiagaraProviderUpdateTimings = GetStructType<CoreVariableNiagaraProviderUpdateTimingsItem[]>;
export type CoreVariableNiagaraProviderUpdateTimingsItem = GetStructType<{
    ProviderType: ENiagaraProviderType;
    UpdateTime: number;
}>;
export type CoreVariablePhysicalMaterialFrictionCoefficients = GetStructType<CoreVariablePhysicalMaterialFrictionCoefficientsItem[]>;
export type CoreVariablePhysicalMaterialFrictionCoefficientsItem = GetStructType<{
    FrictionCoefficient: number;
    PhysicalMaterialType: EPhysicalMaterialType;
}>;
export type CoreVariablePlacesOfInterest = GetStructType<CoreVariablePlacesOfInterestItem[]>;
...
export type CoreVariableRadiationInnerOffsetPresetValues = GetStructType<CoreVariableRadiationInnerOffsetPresetValuesItem[]>;
export type CoreVariableRadiationInnerOffsetPresetValuesItem = GetStructType<{
    Preset: ERadiationInnerOffsetPreset;
    Value: number;
}>;
export type CoreVariableRadiationPresetValues = GetStructType<CoreVariableRadiationPresetValuesItem[]>;
...
export type CoreVariableRarityLuckIncrease = GetStructType<CoreVariableRarityLuckIncreaseItem[]>;
export type CoreVariableRarityLuckIncreaseItem = GetStructType<{
    LuckIncrease: number;
    Rarity: EArtifactRarity;
}>;
export type CoreVariableReputationRepairCostModifiers = GetStructType<CoreVariableReputationRepairCostModifiersItem[]>;
...
export type CoreVariableStaminaRegenStateCoefs = GetStructType<CoreVariableStaminaRegenStateCoefsItem[]>;
export type CoreVariableStaminaRegenStateCoefsItem = GetStructType<{
    StateTag: EStateTag;
    Value: number;
}>;
export type CoreVariableStrikeGrenadeResistCoefs = GetStructType<CoreVariableStrikeGrenadeResistCoefsItem[]>;
...
export type CoreVariableWeightAzimuthArrayPsyPhantom = GetStructType<CoreVariableWeightAzimuthArrayPsyPhantomItem[]>;
export type CoreVariableWeightAzimuthArrayPsyPhantomItem = GetStructType<{
    MaxAngle: number;
    MinAngle: number;
    Weight: number;
}>;
export type CoreVariableWoundCausingDamageSourceTypes = GetStructType<EDamageSource[]>;
...
export type CorpseClueStashPrototypeCorpseClueData = GetStructType<CorpseClueStashPrototypeCorpseClueDataItem[]>;
export type CorpseClueStashPrototypeCorpseClueDataItem = GetStructType<{
    Rank: ERank;
    RankClue: CorpseClueStashPrototypeRankClue;
}>;
export type CorpseClueStashPrototypeRankClue = GetStructType<CorpseClueStashPrototypeRankClueItem[]>;
...
export type CoverEvaluatorPrototypeNewLocationAdvantageCoeffsOverride = GetStructType<{
    NoCover: number;
}>;
...
export type DailySchedulePrototypeAvailableNeeds = GetStructType<EContextualActionNeeds[]>;
export type DailySchedulePrototypeScheduleIntervals = GetStructType<DailySchedulePrototypeScheduleIntervalsItem[]>;
...
export type DebugItemGeneratorPrototypeItemGenerator = GetStructType<DebugItemGeneratorPrototypeItemGeneratorItem[]>;
...
export type DebugItemGeneratorPrototypePossibleItems = GetStructType<DebugItemGeneratorPrototypePossibleItemsItem[]>;
...
export type DestructibleObjectPrototypeAssetOptions = GetStructType<DestructibleObjectPrototypeAssetOptionsItem[]>;
export type DestructibleObjectPrototypeAssetOptionsItem = GetStructType<{
    AssetPath: string;
    AssetWeight: number;
}>;
export type DestructibleObjectPrototypeDestructibleActions = GetStructType<DestructibleObjectPrototypeDestructibleActionsItem[]>;
...
export type DestructibleObjectPrototypeIgnoredDamageTypes = GetStructType<EDamageType[]>;
export type DestructibleObjectPrototypeObjectPhaseSettings = GetStructType<DestructibleObjectPrototypeObjectPhaseSettingsItem[]>;
...
export type DetectorPrototypeAnomalyTexturePaths = GetStructType<DetectorPrototypeAnomalyTexturePathsItem[]>;
...
export type DialogChainPrototypeDialogMembers = GetStructType<DialogChainPrototypeDialogMembersItem[]>;
...
export type DialogPrototypeActions = GetStructType<DialogPrototypeActionsItem[]>;
export type DialogPrototypeActionsItem = GetStructType<{
    DialogAction: EDialogAction;
    DialogActionParam: string;
}>;
export type DialogPrototypeConditions = GetStructType<DialogPrototypeConditionsItem[]>;
...
export type DialogPrototypeDialogActions = GetStructType<DialogPrototypeDialogActionsItem[]>;
...
export type DialogPrototypeDialogAnimations = GetStructType<DialogPrototypeDialogAnimationsItem[]>;
...
export type DialogPrototypeDialogAnswerActions = GetStructType<DialogPrototypeDialogActionsItem[]>;
export type DialogPrototypeDialogMembersAnimations = GetStructType<DialogPrototypeDialogMembersAnimationsItem[]>;
...
export type DialogPrototypeTopicAvailabilityConditions = GetStructType<DialogPrototypeTopicAvailabilityConditionsItem[]>;
...
export type DifficultyPrototypeAgentCooldownMultipliers = GetStructType<DifficultyPrototypeAgentCooldownMultipliersItem[]>;
...
export type DifficultyPrototypeCooldownMultipliers = GetStructType<DifficultyPrototypeCooldownMultipliersItem[]>;
...
export type DifficultyPrototypePsyPhantomNPCOverrides = GetStructType<DifficultyPrototypePsyPhantomNPCOverridesItem[]>;
...
export type DifficultyPrototypeTotalSaveLimits = GetStructType<DifficultyPrototypeTotalSaveLimitsItem[]>;
...
export type DoorPrototypeLockedByGlobalVariable = GetStructType<DoorPrototypeLockedByScenarioFlagItem[]>;
export type DoorPrototypeLockedByItemPrototype = GetStructType<DoorPrototypeLockedByItemPrototypeItem[]>;
export type DoorPrototypeLockedByItemPrototypeItem = GetStructType<{
    ItemCount: number;
    ItemPrototypeSID: string;
}>;
export type DoorPrototypeLockedByScenarioFlag = GetStructType<DoorPrototypeLockedByScenarioFlagItem[]>;
...
export type EffectPrototypeAffectedStaminaActionTypes = GetStructType<EStaminaAction[]>;
export type EffectPrototypeAmmoTypeProjectiles = GetStructType<EffectPrototypeAmmoTypeProjectilesItem[]>;
export type EffectPrototypeAmmoTypeProjectilesItem = GetStructType<{
    AmmoType: EAmmoType;
    ProjectilePrototypeSID: string;
}>;
export type EffectPrototypeApplicableEffects = GetStructType<EffectPrototypeApplicableEffectsItem[]>;
export type EffectPrototypeApplicableEffectsItem = GetStructType<{
    EffectSID: string;
    RemoveOnTransition: boolean;
}>;
export type EffectPrototypeArtifactEquipmentSlots = GetStructType<EInventoryEquipmentSlot[]>;
...
export type EffectPrototypeEffectModifiers = GetStructType<EffectPrototypeEffectModifiersItem[]>;
...
export type EffectSourcePriorityPrototypeSourcePriorities = GetStructType<EffectSourcePriorityPrototypeSourcePrioritiesItem[]>;
...
export type EmissionPrototypeAIEvents = GetStructType<EmissionPrototypeAIEventsItem[]>;
...
export type EmissionPrototypeStages = GetStructType<EmissionPrototypeStagesItem[]>;
...
export type ExplosionPrototypePhysicalMaterialEffects = GetStructType<ExplosionPrototypePhysicalMaterialEffectsItem[]>;
...
export type FaceBlockingBlendMaskPrototypeBlockingMasks = GetStructType<FaceBlockingBlendMaskPrototypeBlockingMasksItem[]>;
...
export type FastTravelLocationPrototypeBlockingGlobalVariables = GetStructType<InfotopicPrototypeBlockingGlobalVariablesItem[]>;
...
export type FastTravelLocationPrototypeRequiredGlobalVariables = GetStructType<InfotopicPrototypeBlockingGlobalVariablesItem[]>;
...
export type FastTravelPrototypeGlobalVariableCoefficient = GetStructType<FastTravelPrototypeGlobalVariableCoefficientItem[]>;
export type FastTravelPrototypeGlobalVariableCoefficientItem = GetStructType<{
    DiscountCoefficient: number;
    GlobalVariablePrototypeSID: string;
    TargetValue: number;
}>;
export type FastTravelPrototypeLocations = GetStructType<FastTravelPrototypeLocationsItem[]>;
...
export type FastTravelPrototypeRequiredItems = GetStructType<FastTravelPrototypeRequiredItemsItem[]>;
...
export type FlashlightPrototypeAdditionalMeshes = GetStructType<FlashlightPrototypeAdditionalMeshesItem[]>;
...
export type FlashlightPrototypeExtraLightDistanceBasedParameters = GetStructType<FlashlightPrototypeExtraLightDistanceBasedParametersItem[]>;
export type FlashlightPrototypeExtraLightDistanceBasedParametersItem = GetStructType<{
...
export type FlashlightPrototypeSocketNamesMeshes = GetStructType<FlashlightPrototypeFac_20_00_v2[]>;
...
export type GeneralNPCObjPrototypeAbilities = GetStructType<Record<HumanAbilityName, ObjPrototypeCat_Jump>>;
export type GeneralNPCObjPrototypeAdvanceParameters = GetStructType<{
    DurationSeconds: number;
    MaxDistance: number;
    Montage: string;
}>;
export type GeneralNPCObjPrototypeAnimationData = GetStructType<ObjPrototypeAnimationDataItem[]>;
export type GeneralNPCObjPrototypeBoneDamageCoefficients = GetStructType<ObjPrototypeBoneDamageCoefficientsItem[]>;
...
export type GeneralNPCObjPrototypeFrontZone = GetStructType<AbilityPrototypeRadius[]>;
...
export type GroomGeneratorPrototypeCategory = GetStructType<GroomGeneratorPrototypeCategoryItem[]>;
...
export type GroomGeneratorPrototypeMaterialInstanceParameters = GetStructType<AttachMeshPrototypeMaterialInstanceParametersItem[]>;
...
export type GroomGeneratorPrototypeVariationReplacementMap = GetStructType<GroomGeneratorPrototypeVariationReplacementMapItem[]>;
...
export type HappyHoursPrototypeHappyHoursRanges = GetStructType<HappyHoursPrototypeHappyHoursRangesItem[]>;
...
export type HearingSensorPrototypeSoundEvents = GetStructType<HearingSensorPrototypeSoundEventsItem[]>;
...
export type ImpactPhysicalMaterialPrototypeImpactPhysicalMaterialsResources = GetStructType<ImpactPhysicalMaterialPrototypeImpactPhysicalMaterialsResourcesItem[]>;
export type ImpactPhysicalMaterialPrototypeImpactPhysicalMaterialsResourcesItem = GetStructType<{
...
export type InfotopicPrototypeBlockingGlobalVariables = GetStructType<InfotopicPrototypeBlockingGlobalVariablesItem[]>;
...
export type InfotopicPrototypeBlockingReputations = GetStructType<InfotopicPrototypeBlockingReputationsItem[]>;
...
export type InfotopicPrototypeRequiredGlobalVariables = GetStructType<InfotopicPrototypeBlockingGlobalVariablesItem[]>;
export type InfotopicPrototypeRequiredLairs = GetStructType<{
    Faction: string;
}>;
export type InfotopicPrototypeRequiredNPCs = StringArray;
export type InfotopicPrototypeRequiredReputations = GetStructType<InfotopicPrototypeBlockingReputationsItem[]>;
...
export type InputManagerConstantActions = GetStructType<SingletonConstantActionsItem[]>;
...
export type ItemGeneratorPrototypePossibleItems = GetStructType<ItemGeneratorPrototypePossibleItemsItem[]>;
...
export type JournalQuestPrototypeRewardTypes = GetStructType<EQuestRewardType[]>;
...
export type KeyboardLayoutPresetAiming = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetAttachSelector = GetStructType<KeyboardLayoutPresetGuitarItem[]>;
export type KeyboardLayoutPresetCodelock = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetDialogue = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetDialogueOnTheGo = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetEditSafeZone = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetEULA = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetExploration = GetStructType<KeyboardLayoutPresetGuitarItem[]>;
export type KeyboardLayoutPresetGuitar = GetStructType<KeyboardLayoutPresetGuitarItem[]>;
...
export type KeyboardLayoutPresetImportantChoice = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetInspectArtifact = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetInventory = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetItemSelector = GetStructType<KeyboardLayoutPresetGuitarItem[]>;
export type KeyboardLayoutPresetJournal = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetLadder = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetMap = GetStructType<KeyboardLayoutPresetMapItem[]>;
...
export type KeyboardLayoutPresetMenu = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetMenuSettings = GetStructType<KeyboardLayoutPresetGuitarItem[]>;
export type KeyboardLayoutPresetModifiers = GetStructType<EPlayerActionInputModifier[]>;
export type KeyboardLayoutPresetNote = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetPDATutorial = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetPlayerContextualAction = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetPopup = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetStackSplitMenu = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetTrade = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetTriggers = GetStructType<EPlayerActionInputTrigger[]>;
export type KeyboardLayoutPresetUpgrades = GetStructType<KeyboardLayoutPresetMapItem[]>;
export type KeyboardLayoutPresetUpgradesPopup = GetStructType<KeyboardLayoutPresetMapItem[]>;
...
export type LairPrototypePossibleInhabitantFactions = GetStructType<LairPrototypePossibleInhabitantFactionsItem[]>;
...
export type LR_MeshGeneratorPrototypeAttaches = GetStructType<LR_MeshGeneratorPrototypeAttachesItem[]>;
...
export type LR_MeshGeneratorPrototypeCustomData = GetStructType<LR_MeshGeneratorPrototypeDirt[]>;
export type LR_MeshGeneratorPrototypeDirt = GetStructType<{
    Distribution: ECustomDataDistribution;
    MaterialGroup: string;
    Variations: LR_MeshGeneratorPrototypeVariations;
}>;
export type LR_MeshGeneratorPrototypeGroom = GetStructType<LR_MeshGeneratorPrototypeGroomItem[]>;
export type LR_MeshGeneratorPrototypeGroomItem = GetStructType<{
    CategoryName: string;
    Variations: LR_MeshGeneratorPrototypeVariations;
}>;
export type LR_MeshGeneratorPrototypeMaterials = GetStructType<LR_MeshGeneratorPrototypeMaterialsItem[]>;
export type LR_MeshGeneratorPrototypeMaterialsItem = GetStructType<{
    MaterialGroup: string;
    Variations: LR_MeshGeneratorPrototypeVariations;
}>;
export type LR_MeshGeneratorPrototypeVariations = GetStructType<AttachMeshPrototypeVariationsItem[]>;
...
export type MeleeWeaponPrototypeSourceEffects = GetStructType<ObjPrototypeEffectsItem[]>;
export type MeleeWeaponPrototypeTargetEffects = GetStructType<ObjPrototypeEffectsItem[]>;
...
export type MeshGeneratorPrototypeAttaches = GetStructType<MeshGeneratorPrototypeAttachesItem[]>;
...
export type MeshGeneratorPrototypeCustomData = GetStructType<MeshGeneratorPrototypeDirt[]>;
export type MeshGeneratorPrototypeDirt = GetStructType<{
    Distribution: ECustomDataDistribution;
    MaterialGroup: string;
    Variations: MeshGeneratorPrototypeVariations;
}>;
export type MeshGeneratorPrototypeGroom = GetStructType<MeshGeneratorPrototypeGroomItem[]>;
export type MeshGeneratorPrototypeGroomItem = GetStructType<{
    CategoryName: string;
    Variations: MeshGeneratorPrototypeVariations;
}>;
export type MeshGeneratorPrototypeMaterials = GetStructType<MeshGeneratorPrototypeMaterialsItem[]>;
export type MeshGeneratorPrototypeMaterialsItem = GetStructType<{
    MaterialGroup: string;
    Variations: MeshGeneratorPrototypeVariations;
}>;
export type MeshGeneratorPrototypeQualityPresetsMeshGenerators = GetStructType<MeshGeneratorPrototypeQualityPresetsMeshGeneratorsItem[]>;
export type MeshGeneratorPrototypeQualityPresetsMeshGeneratorsItem = GetStructType<{
    MeshGeneratorSID: string;
    QualityPresetIndex: number;
}>;
export type MeshGeneratorPrototypeVariations = GetStructType<MeshGeneratorPrototypeVariationsItem[]>;
...
export type MeshPrototypeAdditionalMeshes = GetStructType<MeshPrototypeAdditionalMeshesItem[]>;
export type MeshPrototypeAdditionalMeshesItem = GetStructType<{
    MeshPath: string;
    MeshPrototypeSID: string;
}>;
export type MeshPrototypeMaterials = GetStructType<MeshPrototypeMaterialsItem[]>;
...
export type MovementFXPrototypeFootstepFX = GetStructType<MovementFXPrototypeFootstepFXItem[]>;
export type MovementFXPrototypeFootstepFXItem = GetStructType<MovementFXPrototypeFootstepFXItemItem[]>;
...
export type MovementFXPrototypeInteractSoundEvent = GetStructType<MovementFXPrototypeInteractSoundEventItem[]>;
...
export type MusicManagerPrototypeCombatTracks = GetStructType<MusicManagerPrototypeCombatTracksItem[]>;
...
export type NotificationEventPrototypeFactionBasedSoundEventInformation = GetStructType<NotificationEventPrototypeFactionBasedSoundEventInformationItem[]>;
export type NotificationEventPrototypeFactionBasedSoundEventInformationItem = GetStructType<{
    Faction: string;
...
export type NPCNeedsPresetPrototypeNeeds = GetStructType<NPCNeedsPresetPrototypeNeedsItem[]>;
...
export type NPCNeedsPresetPrototypeOnCompleted = GetStructType<NPCNeedsPresetPrototypeOnCompletedItem[]>;
...
export type NPCNightVisionSetupPrototypeMeshOffsetParams = GetStructType<NPCNightVisionSetupPrototypeMeshOffsetParamsItem[]>;
export type NPCNightVisionSetupPrototypeMeshOffsetParamsItem = GetStructType<{
    MeshPath: string;
    OffsetRotator: SpawnActorPrototypeRotation;
    OffsetVector: AIGlobalRelativeLocation;
}>;
export type NPCNightVisionSetupPrototypePointLightOffsets = GetStructType<NPCNightVisionSetupPrototypePointLightOffsetsItem[]>;
...
export type NPCNightVisionSetupPrototypeSocketNamesMeshes = GetStructType<NPCNightVisionSetupPrototypeSocketNamesMeshesItem[]>;
...
export type NPCWeaponAttributesPrototypeParticlesBasedOnHeating = GetStructType<NPCWeaponAttributesPrototypeParticlesBasedOnHeatingItem[]>;
export type NPCWeaponAttributesPrototypeParticlesBasedOnHeatingItem = GetStructType<{
    PostShooting: AttachPrototypeShooting;
    Shooting: AttachPrototypeShooting;
    VFXGroupName: string;
}>;
...
export type NPCWeaponSettingsPrototypeCombatSynchronizationScore = GetStructType<NPCWeaponSettingsPrototypeCombatSynchronizationScoreItem[]>;
export type NPCWeaponSettingsPrototypeCombatSynchronizationScoreItem = GetStructType<{
    Score: number;
    TokenTag: string;
}>;
...
export type ObjAimAssistParamsPrototypeBoneClusters = GetStructType<ObjAimAssistParamsPrototypeBoneClustersItem[]>;
...
export type ObjCustomAbilityDialogPrototypeAbilityDialogues = GetStructType<ObjCustomAbilityDialogPrototypeAbilityDialoguesItem[]>;
export type ObjCustomAbilityDialogPrototypeAbilityDialoguesItem = GetStructType<{
    AbilityTag: string;
...
export type ObjEffectMaxParamsPrototypeMaxEffectValues = GetStructType<ObjEffectMaxParamsPrototypeMaxEffectValuesItem[]>;
...
export type ObjHoldBreathParamsPrototypePostHoldBreathParameters = GetStructType<ObjHoldBreathParamsPrototypePostHoldBreathParametersItem[]>;
export type ObjHoldBreathParamsPrototypePostHoldBreathParametersItem = GetStructType<{
    EffectPrototypeSIDs: SingletonConstantArmy;
    Threshold: number;
}>;
...
export type ObjOnHitParamsPrototypeDamageTypeEffects = GetStructType<ObjOnHitParamsPrototypeDamageTypeEffectsItem[]>;
export type ObjOnHitParamsPrototypeDamageTypeEffectsItem = GetStructType<{
    DamageType: EDamageType;
    Effects: ObjOnHitParamsPrototypeEffects;
}>;
export type ObjOnHitParamsPrototypeDirectionalDamageEffects = GetStructType<ObjOnHitParamsPrototypeDirectionalDamageEffectsItem[]>;
export type ObjOnHitParamsPrototypeDirectionalDamageEffectsItem = GetStructType<ObjOnHitParamsPrototypeDirectionalDamageEffectsItemItem[]>;
export type ObjOnHitParamsPrototypeDirectionalDamageEffectsItemItem = GetStructType<{
    EffectSID: string;
    MaxDamage: number;
...
export type ObjOnHitParamsPrototypeEffects = GetStructType<ObjOnHitParamsPrototypeEffectsItem[]>;
...
export type ObjPrototypeAnimationData = GetStructType<ObjPrototypeAnimationDataItem[]>;
...
export type ObjPrototypeAttacksConditions = GetStructType<ObjPrototypeAttacksConditionsItem[]>;
...
export type ObjPrototypeBoneBleedingCoefficients = GetStructType<ObjPrototypeBoneDamageCoefficientsItem[]>;
export type ObjPrototypeBoneDamageCoefficients = GetStructType<ObjPrototypeBoneDamageCoefficientsItem[]>;
export type ObjPrototypeBoneDamageCoefficientsItem = GetStructType<{
    DamageBone: EDamageBone;
    DamageCoef: number;
}>;
export type ObjPrototypeBoneDamageMap = GetStructType<ObjPrototypeBoneDamageMapItem[]>;
...
export type ObjPrototypeDisableMovementWeightThreshold = GetStructType<ObjPrototypeDisableMovementWeightThresholdItem[]>;
...
export type ObjPrototypeDualCurveEffects = GetStructType<ObjPrototypeDualCurveEffectsItem[]>;
...
export type ObjPrototypeEffectsOnPlayer = GetStructType<ObjPrototypeEffectsItem[]>;
...
export type ObjPrototypeFriendlyTracePoints = GetStructType<ObjPrototypeFriendlyTracePointsItem[]>;
...
export type ObjPrototypeInteractionData = GetStructType<ObjPrototypeInteractionDataItem[]>;
...
export type ObjPrototypeInvisibilityEffects = GetStructType<ObjPrototypeEffectsItem[]>;
...
export type ObjPrototypePathBuilderVelocities = GetStructType<ObjPrototypePathBuilderVelocitiesItem[]>;
...
export type ObjPrototypePerBoneIgnoreDispersionModifiers = GetStructType<ObjPrototypePerBoneIgnoreDispersionModifiersItem[]>;
...
export type ObjPrototypeSingleCurveEffects = GetStructType<ObjPrototypeSingleCurveEffectsItem[]>;
export type ObjPrototypeSingleCurveEffectsItem = GetStructType<{
    DepthCurve: string;
    EffectSID: string;
}>;
export type ObjPrototypeSkeletalMeshTraceBoneMap = GetStructType<ObjPrototypeSkeletalMeshTraceBoneMapItem[]>;
...
export type ObjPrototypeStaminaDisableThresholds = GetStructType<ObjPrototypeStaminaDisableThresholdsItem[]>;
...
export type ObjPrototypeTracePoints = GetStructType<ObjPrototypeTracePointsItem[]>;
...
export type ObjPrototypeWaterImmersionLevels = GetStructType<ObjPrototypeWaterImmersionLevelsItem[]>;
...
export type ObjWeightParamsPrototypeWeightEffectParams = GetStructType<ObjWeightParamsPrototypeWeightEffectParamsItem[]>;
...
export type PackOfItemsGroupPrototypeItems = GetStructType<PackOfItemsGroupPrototypeItemsItem[]>;
export type PackOfItemsGroupPrototypeItemsItem = GetStructType<{
    ItemPrototypeSID: string;
    MinDurability: number;
    Weight: number;
}>;
export type PackOfItemsGroupPrototypePackOfItemsSettings = GetStructType<PackOfItemsGroupPrototypePackOfItemsSettingsItem[]>;
...
export type PDATutorialPrototypeInputMappings = GetStructType<PDATutorialPrototypeInputMappingsItem[]>;
...
export type PDATutorialPrototypeVisibleDifficulties = GetStructType<EGameDifficulty[]>;
...
export type PlayerMeshGeneratorPrototypeAttaches = GetStructType<PlayerMeshGeneratorPrototypeAttachesItem[]>;
...
export type PlayerWeaponAttributesPrototypeParticlesBasedOnHeating = GetStructType<PlayerWeaponAttributesPrototypeParticlesBasedOnHeatingItem[]>;
export type PlayerWeaponAttributesPrototypeParticlesBasedOnHeatingItem = GetStructType<{
    PostShooting: AttachPrototypeShooting;
    Shooting: AttachPrototypeShooting;
    VFXGroupName: string;
}>;
...
export type PsyMeshGeneratorPrototypeAttaches = GetStructType<PsyMeshGeneratorPrototypeAttachesItem[]>;
export type PsyMeshGeneratorPrototypeAttachesItem = GetStructType<{
    BlockingSlots: SingletonConstantZombie;
    BodyMeshSID: string;
    Weight: number;
}>;
export type PsyMeshGeneratorPrototypeAttachments = GetStructType<PsyMeshGeneratorPrototypeCap[]>;
...
export type QuestItemGeneratorPrototypeItemGenerator = GetStructType<QuestItemGeneratorPrototypeHead[]>;
export type QuestItemGeneratorPrototypePossibleItems = GetStructType<QuestItemGeneratorPrototypePossibleItemsItem[]>;
...
export type QuestItemPrototypeEffectsDisplayTypes = GetStructType<EEffectDisplayType[]>;
...
export type QuestMeshGeneratorPrototypeAttaches = GetStructType<QuestMeshGeneratorPrototypeAttachesItem[]>;
...
export type QuestMeshGeneratorPrototypeAttachments = GetStructType<QuestMeshGeneratorPrototypeCap[]>;
...
export type QuestMeshGeneratorPrototypeCustomData = GetStructType<QuestMeshGeneratorPrototypeChevron_index[]>;
export type QuestMeshGeneratorPrototypeGroom = GetStructType<QuestMeshGeneratorPrototypeGroomItem[]>;
export type QuestMeshGeneratorPrototypeGroomItem = GetStructType<{
    CategoryName: string;
    Variations: QuestMeshGeneratorPrototypeVariations;
}>;
export type QuestMeshGeneratorPrototypeMaterials = GetStructType<QuestMeshGeneratorPrototypeMaterialsItem[]>;
export type QuestMeshGeneratorPrototypeMaterialsItem = GetStructType<{
    MaterialGroup: string;
    Variations: QuestMeshGeneratorPrototypeVariations;
}>;
export type QuestMeshGeneratorPrototypeVariations = GetStructType<QuestMeshGeneratorPrototypeVariationsItem[]>;
export type QuestMeshGeneratorPrototypeVariationsItem = GetStructType<{
    VariationIndex: number;
    Weight: number;
}>;
export type QuestNodePrototype = QuestNodePrototypeAchievementUnlock | QuestNodePrototypeActivateAnomaly | QuestNodePrototypeActivateDataLayerCombination | QuestNodePrototypeActivateInteractableObject | QuestNodePrototypeActivateRestrictor | QuestNodePrototypeAddNote | QuestNodePrototypeAddOrRemoveFromSquad | QuestNodePrototypeAddTechnicianSkillOrUpgrade | QuestNodePrototypeAddTutorialToPDA | QuestNodePrototypeALifeDirectorZoneSwitch | QuestNodePrototypeBridgeCleanUp | QuestNodePrototypeBridgeEvent | QuestNodePrototypeCancelAllSideQuests | QuestNodePrototypeChangeFaction | QuestNodePrototypeChangeRelationships | QuestNodePrototypeCondition | QuestNodePrototypeConsoleCommand | QuestNodePrototypeContainer | QuestNodePrototypeDeactivateZone | QuestNodePrototypeDespawn | QuestNodePrototypeDisableNPCBark | QuestNodePrototypeDisableNPCInteraction | QuestNodePrototypeEmissionScheduleControl | QuestNodePrototypeEmissionStart | QuestNodePrototypeEnableDataLayer | QuestNodePrototypeEnd | QuestNodePrototypeEquipItemInHands | QuestNodePrototypeFlashlightOnOff | QuestNodePrototypeForceInteract | QuestNodePrototypeGiveCache | QuestNodePrototypeHideLoadingScreen | QuestNodePrototypeHideTutorial | QuestNodePrototypeIf | QuestNodePrototypeItemAdd | QuestNodePrototypeItemRemove | QuestNodePrototypeLoadAsset | QuestNodePrototypeLookAt | QuestNodePrototypeMoveInventory | QuestNodePrototypeNPCBark | QuestNodePrototypeOnAbilityEndedEvent | QuestNodePrototypeOnAbilityUsedEvent | QuestNodePrototypeOnDialogStartEvent | QuestNodePrototypeOnEmissionFinishEvent | QuestNodePrototypeOnEmissionStageActivated | QuestNodePrototypeOnEmissionStageFinished | QuestNodePrototypeOnEmissionStartEvent | QuestNodePrototypeOnFactionBecomeEnemyEvent | QuestNodePrototypeOnFactionBecomeFriendEvent | QuestNodePrototypeOnGetCompatibleAttachEvent | QuestNodePrototypeOnHitEvent | QuestNodePrototypeOnInfotopicFinishEvent | QuestNodePrototypeOnInteractEvent | QuestNodePrototypeOnJournalQuestEvent | QuestNodePrototypeOnKillerCheckEvent | QuestNodePrototypeOnMoneyAmountReachedEvent | QuestNodePrototypeOnNPCBecomeEnemyEvent | QuestNodePrototypeOnNPCBecomeFriendEvent | QuestNodePrototypeOnNPCCreateEvent | QuestNodePrototypeOnNPCDeathEvent | QuestNodePrototypeOnNPCDefeatEvent | QuestNodePrototypeOnPlayerGetItemEvent | QuestNodePrototypeOnPlayerLostItemEvent | QuestNodePrototypeOnPlayerNoticedEvent | QuestNodePrototypeOnPlayerRankReachedEvent | QuestNodePrototypeOnSignalReceived | QuestNodePrototypeOnTickEvent | QuestNodePrototypeOnUpgradeInstallEvent | QuestNodePrototypePlayEffect | QuestNodePrototypePlayPostProcess | QuestNodePrototypePlaySound | QuestNodePrototypePlayVideo | QuestNodePrototypeProtectLairNPCSquadItem | QuestNodePrototypeRandom | QuestNodePrototypeReputationLocker | QuestNodePrototypeResetAI | QuestNodePrototypeRestrictionArea | QuestNodePrototypeRestrictSave | QuestNodePrototypeSaveGame | QuestNodePrototypeScheduledContainer | QuestNodePrototypeSearchPoint | QuestNodePrototypeSendSignal | QuestNodePrototypeSequenceStart | QuestNodePrototypeSetAIBehavior | QuestNodePrototypeSetCharacterEffect | QuestNodePrototypeSetCharacterParam | QuestNodePrototypeSetDialog | QuestNodePrototypeSetDurabilityParam | QuestNodePrototypeSetFactionRestriction | QuestNodePrototypeSetGlobalVariable | QuestNodePrototypeSetHubOwner | QuestNodePrototypeSetItemGenerator | QuestNodePrototypeSetJournal | QuestNodePrototypeSetLocationName | QuestNodePrototypeSetMeshGenerator | QuestNodePrototypeSetName | QuestNodePrototypeSetNPCSequentialAbility | QuestNodePrototypeSetPersonalRestriction | QuestNodePrototypeSetQuestGiver | QuestNodePrototypeSetSpaceRestrictor | QuestNodePrototypeSetTime | QuestNodePrototypeSetTimer | QuestNodePrototypeSetWeather | QuestNodePrototypeSetWounded | QuestNodePrototypeShowFadeScreen | QuestNodePrototypeShowLoadingScreen | QuestNodePrototypeShowMarker | QuestNodePrototypeShowTutorialWidget | QuestNodePrototypeSpawn | QuestNodePrototypeSpawnAnomaly | QuestNodePrototypeSpawnAnomalySpawner | QuestNodePrototypeSpawnArtifactSpawner | QuestNodePrototypeSpawnDeadBody | QuestNodePrototypeSpawnItemContainer | QuestNodePrototypeSpawnLair | QuestNodePrototypeSpawnSafeZone | QuestNodePrototypeSpawnSingleObj | QuestNodePrototypeSpawnSquad | QuestNodePrototypeSpawnTrigger | QuestNodePrototypeStartBenchmark | QuestNodePrototypeSwitchQuestItemState | QuestNodePrototypeTechnical | QuestNodePrototypeTeleportCharacter | QuestNodePrototypeTimeLock | QuestNodePrototypeToggleLairActivity | QuestNodePrototypeToggleNPCHidden | QuestNodePrototypeTrackJournal | QuestNodePrototypeTrackShelter | QuestNodePrototypeTrigger;
...
export type QuestNodePrototypeConnections = GetStructType<QuestNodePrototypeConnectionsItem[]>;
...
export type QuestNodePrototypeLaunchers = GetStructType<QuestNodePrototypeLaunchersItem[]>;
...
export type QuestNPCGeneratorPrototypeItemGenerator = GetStructType<QuestNPCGeneratorPrototypeItemGeneratorItem[]>;
...
export type QuestNPCGeneratorPrototypePossibleItems = GetStructType<QuestNPCGeneratorPrototypePossibleItemsItem[]>;
...
export type QuestObjPrototypeStaminaDisableThresholds = GetStructType<QuestObjPrototypeStaminaDisableThresholdsItem[]>;
...
export type QuestRewardsPrototypeItemGenerator = GetStructType<QuestRewardsPrototypeItemGeneratorItem[]>;
...
export type QuestRewardsPrototypePossibleItems = GetStructType<QuestRewardsPrototypePossibleItemsItem[]>;
...
export type QuestStashBodyItemGeneratorPrototypeItemGenerator = GetStructType<QuestStashBodyItemGeneratorPrototypeItemGeneratorItem[]>;
export type QuestStashBodyItemGeneratorPrototypeItemGeneratorItem = GetStructType<{
    bAllowSameCategoryGeneration: boolean;
    Category: EItemGenerationCategory;
    PlayerRank: ERank;
    PossibleItems: QuestStashBodyItemGeneratorPrototypePossibleItems;
}>;
export type QuestStashBodyItemGeneratorPrototypePossibleItems = GetStructType<QuestStashBodyItemGeneratorPrototypePossibleItemsItem[]>;
export type QuestStashBodyItemGeneratorPrototypePossibleItemsItem = GetStructType<{
    AmmoMaxCount: number;
    AmmoMinCount: number;
    Attaches: QuestRewardsPrototypeUpgrades;
    bRequireWeapon: boolean;
...
export type ref = GetStructType<(refFleshBoneDamageMapItem | refRiflesCompatibleAttachmentItem)[]>;
...
export type RelationPrototypeAttackLairRestrictions = GetStructType<Record<`${Faction}->${Faction}`, boolean>>;
export type RelationPrototypeCharacterReactions = GetStructType<RelationPrototypeFactionReactionsItem[]>;
...
export type RelationPrototypeFactionReactions = GetStructType<RelationPrototypeFactionReactionsItem[]>;
...
export type RelationPrototypeRelationLevelRanges = GetStructType<RelationPrototypeRelationLevelRangesItem[]>;
export type RelationPrototypeRelationLevelRangesItem = GetStructType<{
    end: number;
    start: number;
}>;
export type RelationPrototypeRelations = GetStructType<Record<`${Faction}<->${Faction}`, number>>;
export type RestrictorsPrototype = GetStructType<{
    OfflineRestrictors: RestrictorsPrototypeOfflineRestrictors;
    SID: string;
}>;
export type RestrictorsPrototypeOfflineRestrictors = GetStructType<RestrictorsPrototypeOfflineRestrictorsItem[]>;
...
export type SaveLoadVariableSaveTypeCategories = GetStructType<SaveLoadVariableSaveTypeCategoriesItem[]>;
...
export type ScriptScriptsArray = GetStructType<(ScriptScriptsArrayItem | string)[]>;
...
export type SingletonConstantActions = GetStructType<SingletonConstantActionsItem[]>;
...
export type SingletonConstantSpeechEventCooldown = GetStructType<SingletonConstantSpeechEventCooldownItem[]>;
...
export type SmartCoverPrototypeEnterCoverOffsets = GetStructType<SmartCoverPrototypeEnterCoverOffsetsItem[]>;
...
export type SmartCoverPrototypeLookFromCoverOffsets = GetStructType<SmartCoverPrototypeEnterCoverOffsetsItem[]>;
export type SmartCoverPrototypePerCoverTypeOffsets = GetStructType<SmartCoverPrototypePerCoverTypeOffsetsItem[]>;
...
export type SmartCoverPrototypeWeaponTypes = GetStructType<SmartCoverPrototypeWeaponTypesItem[]>;
...
export type SpawnActorPrototypeAnomaliesLocationRotation = GetStructType<QuestNodePrototypeRotationAfterMoveTo[]>;
export type SpawnActorPrototypeAnomaliesPresets = GetStructType<SpawnActorPrototypeAnomaliesPresetsItem[]>;
...
export type SpawnActorPrototypeAnomaliesSpawnData = GetStructType<SpawnActorPrototypeAnomaliesSpawnDataItem[]>;
...
export type SpawnActorPrototypeAttachReferences = GetStructType<SpawnActorPrototypeAttachReferencesItem[]>;
export type SpawnActorPrototypeAttachReferencesItem = GetStructType<{
    ActorGuid: string;
    AttachReference: string;
}>;
export type SpawnActorPrototypeCenterLocationRotation = GetStructType<SpawnActorPrototypeCenterLocationRotationItem[]>;
export type SpawnActorPrototypeCenterLocationRotationItem = GetStructType<{
    Rotation: SpawnActorPrototypeRotation;
    Vector: AIGlobalRelativeLocation;
}>;
export type SpawnActorPrototypeContextualActionPreconditions = GetStructType<SpawnActorPrototypeContextualActionPreconditionsItem[]>;
export type SpawnActorPrototypeContextualActionPreconditionsItem = GetStructType<{
    AllowedAgentType: number;
    AllowedFactions: NPCPrototypeSkills;
    AllowedUserRestriction: string;
    GlobalVariableName: string;
...
export type SpawnActorPrototypeElectroBakedData = GetStructType<SpawnActorPrototypeElectroBakedDataItem[]>;
...
export type SpawnActorPrototypeFactions = GetStructType<SpawnActorPrototypeFactionsItem[]>;
export type SpawnActorPrototypeFactionsItem = GetStructType<{
    Faction: string;
    SpawnBoxes: SpawnActorPrototypeSpawnBoxes;
}>;
export type SpawnActorPrototypeFreeformTriggerVertices = GetStructType<AbilityPrototypeRadius[]>;
export type SpawnActorPrototypeInLocationRotation = GetStructType<SpawnActorPrototypeInLocationRotationItem[]>;
export type SpawnActorPrototypeInLocationRotationItem = GetStructType<SpawnActorPrototypeCenterLocationRotationItem[]>;
export type SpawnActorPrototypeItemGenerators = GetStructType<SpawnActorPrototypeItemGeneratorsItem[]>;
export type SpawnActorPrototypeItemGeneratorSettings = GetStructType<SpawnActorPrototypeItemGeneratorSettingsItem[]>;
...
export type SpawnActorPrototypeItems = GetStructType<SpawnActorPrototypeItemsItem[]>;
...
export type SpawnActorPrototypeLightningBallLocation = GetStructType<AIGlobalRelativeLocation[]>;
export type SpawnActorPrototypeLightningBallNavigationPoints = GetStructType<SpawnActorPrototypeLightningBallNavigationPointsItem[]>;
export type SpawnActorPrototypeLightningBallNavigationPointsItem = GetStructType<{
...
export type SpawnActorPrototypeLightningBallNeighborLocations = GetStructType<number[]>;
...
export type SpawnActorPrototypePath = GetStructType<SpawnActorPrototypePathItem[]>;
export type SpawnActorPrototypePathItem = GetStructType<{
    Location: string;
    MovementType: EMovementBehaviour;
}>;
export type SpawnActorPrototypePatrolPointLinks = GetStructType<SpawnActorPrototypePatrolPointLinksItem[]>;
export type SpawnActorPrototypePatrolPointLinksItem = GetStructType<{
    DestinationPointIndex: number;
    Weight: number;
}>;
export type SpawnActorPrototypePatrolPoints = GetStructType<SpawnActorPrototypePatrolPointsItem[]>;
...
export type SpawnActorPrototypePossibleInhabitantFactions = GetStructType<SpawnActorPrototypePossibleInhabitantFactionsItem[]>;
...
export type SpawnActorPrototypeSpawnBoxes = GetStructType<SpawnActorPrototypeSpawnBoxesItem[]>;
export type SpawnActorPrototypeSpawnBoxesItem = GetStructType<{
    Extent: string;
    Location: string;
}>;
export type SpawnActorPrototypeSpawnedGenericMembers = GetStructType<SpawnActorPrototypeSpawnedGenericMembersItem[]>;
export type SpawnActorPrototypeSpawnedGenericMembersItem = GetStructType<{
    SpawnedPrototypeSID: string;
    SpawnedSquadMembersCount: number;
}>;
export type SpawnActorPrototypeSpawnSettingsPerArchetypes = GetStructType<Record<Archetype, GenericLairPrototypeRat>>;
...
export type StashPrototypeAttachParams = GetStructType<StashPrototypeAttachParamsItem[]>;
export type StashPrototypeAttachParamsItem = GetStructType<{
    MaxPrice: number;
}>;
export type StashPrototypeConsumablesParams = GetStructType<StashPrototypeGrenadesParamsItem[]>;
export type StashPrototypeGrenadesParams = GetStructType<StashPrototypeGrenadesParamsItem[]>;
...
export type StashPrototypeHealthParams = GetStructType<StashPrototypeHealthParamsItem[]>;
...
export type StashPrototypeItemGenerators = GetStructType<StashPrototypeItemGeneratorsItem[]>;
...
export type StashPrototypePistolWeaponParams = GetStructType<StashPrototypePistolWeaponParamsItem[]>;
...
export type StashPrototypePrimaryWeaponParams = GetStructType<StashPrototypePistolWeaponParamsItem[]>;
export type StashPrototypeSecondaryWeaponParams = GetStructType<StashPrototypePistolWeaponParamsItem[]>;
...
export type ThreatPrototypeActions = GetStructType<ThreatPrototypeActionsItem[]>;
...
export type ThreatPrototypeThreatParams = GetStructType<ThreatPrototypeThreatParamsItem[]>;
...
export type TradePrototypeBuyDiscounts = GetStructType<TradePrototypeBuyDiscountsItem[]>;
export type TradePrototypeBuyDiscountsItem = GetStructType<{
    ConditionSID: string;
    Modifier: number;
}>;
export type TradePrototypeBuyLimitations = GetStructType<EItemType[]>;
export type TradePrototypeSellDiscounts = GetStructType<TradePrototypeBuyDiscountsItem[]>;
export type TradePrototypeTradeGenerators = GetStructType<TradePrototypeTradeGeneratorsItem[]>;
...
export type UpdatePopupPrototypeTabData = GetStructType<UpdatePopupPrototypeTabDataItem[]>;
...
export type UpgradePrototypeBlockingGlobalVariables = GetStructType<DoorPrototypeLockedByScenarioFlagItem[]>;
export type UpgradePrototypeConnectionLines = GetStructType<EConnectionLineState[]>;
export type UpgradePrototypeEffectPrototypeSIDs = StringArray;
export type UpgradePrototypeRequiredGlobalVariables = GetStructType<DoorPrototypeLockedByScenarioFlagItem[]>;
...
export type VisionScannerPrototypeMinSignificantVisibilityScore = GetStructType<number[]>;
...
export type WaterVariable = GetStructType<WaterVariableRainyWaterMaterialsItem[]>;
...
export type WeaponGeneralSetupPrototypeAdditionalMeshes = GetStructType<WeaponGeneralSetupPrototypeAdditionalMeshesItem[]>;
...
export type WeaponGeneralSetupPrototypeAmmoTypeProjectiles = GetStructType<EffectPrototypeAmmoTypeProjectilesItem[]>;
export type WeaponGeneralSetupPrototypeCompatibleAttachments = GetStructType<WeaponGeneralSetupPrototypeCompatibleAttachmentsItem[]>;
export type WeaponGeneralSetupPrototypeCompatibleAttachmentsItem = GetStructType<{
...
export type WeaponGeneralSetupPrototypeFireIntervalModifiers = GetStructType<number[]>;
...
export type WeaponGeneralSetupPrototypeMaterials = GetStructType<MeshPrototypeMaterialsItem[]>;
...
export type WeaponGeneralSetupPrototypePreinstalledAttachmentsItemPrototypeSIDs = GetStructType<WeaponGeneralSetupPrototypePreinstalledAttachmentsItemPrototypeSIDsItem[]>;
export type WeaponGeneralSetupPrototypePreinstalledAttachmentsItemPrototypeSIDsItem = GetStructType<{
    AttachSID: string;
    bHiddenInInventory: boolean;
}>;
export type WeaponGeneralSetupPrototypeRadiusExtensionModifiers = GetStructType<{
    MaxRadiusExtensionModifier: number;
    PerIterationRadiusExtensionModifier: number;
    RadiusExtensionBulletCount: number;
}>;
export type WeaponGeneralSetupPrototypeRadiusNormalizationModifiers = GetStructType<{
...
export type WeaponGeneralSetupPrototypeReloadTypes = GetStructType<EAnimationReloadTypes[]>;
...
export type WeaponGeneralSetupPrototypeWeaponJamParams = GetStructType<WeaponGeneralSetupPrototypeWeaponJamParamsItem[]>;
export type WeaponGeneralSetupPrototypeWeaponJamParamsItem = GetStructType<{
    FullJamTime: number;
    JamChanceCoef: number;
}>;
export type WeaponGeneralSetupPrototypeWeaponReloadTimePerAttachment = GetStructType<WeaponGeneralSetupPrototypeWeaponReloadTimePerAttachmentItem[]>;
export type WeaponGeneralSetupPrototypeWeaponReloadTimePerAttachmentItem = GetStructType<{
    AttachPrototypeSID: string;
    FullReloadTimeMultiplier: number;
    SingleBulletReloadTimeMultiplier: number;
    TacticalReloadTimeMultiplier: number;
...
export type WeaponGeneralSetupPrototypeWeaponStaticMeshParts = GetStructType<WeaponGeneralSetupPrototypeWeaponStaticMeshPartsItem[]>;
export type WeaponGeneralSetupPrototypeWeaponStaticMeshPartsItem = GetStructType<{
...
export type WeaponPrototypeSectionSettings = GetStructType<ArmorPrototypeSectionSettingsItem[]>;
...
export type WeatherChainPrototypeTransitionSteps = GetStructType<WeatherChainPrototypeTransitionStepsItem[]>;
...
export type WeatherChainPrototypeWeatherChains = GetStructType<WeatherChainPrototypeWeatherChainsItem[]>;
...
export type WeatherPrototypeWeatherParams = GetStructType<WeatherPrototypeWeatherParamsItem[]>;
...
export type WeatherPrototypeWeatherTransitions = GetStructType<WeatherPrototypeWeatherTransitionsItem[]>;
